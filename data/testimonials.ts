...
export const testimonials: Testimonial[] = [
  ...
  {
    text: "طلبت هدية لأهلي وكان التغليف رائعًا. الجميع أثنى على الجودة والمذاق الاستثنائي. شكرًا طيبة.",
    name: "مريم الكعبي",
  ...
  {
    text: "أطلب من طيبة في كل رمضان. التمور وصلتني في حالة مثالية والتوصيل كان سريعًا جدًا. خدمة احترافية.",
    name: "خالد العتيبي",
    location: "الكويت",
    avatar: "خ",
  },
