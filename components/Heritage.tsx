        ...
        <div className="heritage-inner">
          ...
          <RevealOnScroll>
            ...
            <p className="section-desc" style={{ marginBottom: 28 }}>
              تأسست "طيبه للتمور" سنة 2011، من عشق أصيل للتمر الخليجي وحرفة الانتقاء الدقيق. بدأنا بعد سنوات من الخبرة في بيع التمر، وأسسنا شركة صغيرة لم تتوقف عن النمو منذ يومها الأول.
            </p>
            <p className="section-desc" style={{ marginBottom: 28 }}>
              نتجول في مزارع القصيم والغاط والمدينة المنورة، وصولًا إلى الأغوار الأردنية، باحثين عن أجود الأصناف وأكثرها نقاءً. وكل صندوق يحمل اسم "طيبه" يحمل معه وعدًا لا نحيد عنه: تمرة اخترناها بأيدينا بأدق المعايير، ووصلت إليكم في أوج نضجها وعطائها.
            </p>
            <p className="section-desc" style={{ marginBottom: 28 }}>
              على مدى السنين، كبرت معنا الثقة، حتى وصلنا لخدمة أكثر من 2000 عميل اختاروا "طيبه" واستمروا معنا. لم يكن الطريق دائمًا سهلًا؛ فسنة 2020 كانت من أصعب السنوات التي مررنا بها، لكن وفاء عملائنا وثقتهم بنا كانا السبب الذي مكّننا من العودة أقوى من قبل.
            </p>
